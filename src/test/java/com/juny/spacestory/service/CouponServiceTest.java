...
public class CouponServiceTest {
  ...
  @InjectMocks
  private AdvertiseCouponService couponService;

  @Mock
  private AdvertiseCouponRepository advertiseCouponRepository;
  ...
  void createAdvertiseCoupons() {
    ...
    assertThat(coupon.startDate()).isEqualTo(expected.startDate());
    assertThat(coupon.endDate()).isEqualTo(expected.endDate());
    assertThat(coupon.price()).isEqualTo(expected.price());
  }
  ...
  void attachCouponToSpace() {
    ...
    // given
    AdvertiseCoupon coupon = AdvertiseCoupon.builder()
      .id(-1L)
    ...
    // when & then
    assertThatThrownBy(
      () -> couponService.updateAdvertiseCoupon(-1L, -1L, true))
